  ...
  resources: {
    en: {
      ...
      httpError: {
        ...
        networkError:
          "Internet connectivity error. Please retry in a few minutes",
        badStatus: {
          ...
          any:
            "An error occured, please contact an administrator with the following code {{code}}"
        },
        badPayload:
          "The request's answer is not valid. Please retry in a few minutes",
      ...
      validation: {
        ...
        notCorrectMinLength:
          "The minimum number of characters is {{minLength}}",
    ...
    fr: {
      default: {
        ...
        entityError:
          "Une erreur est survenue lors de la récupération de l'entité",
      ...
      httpError: {
        badUrl:
          "Url invalide. Merci d'essayer de nouveau dans quelques minutes",
        timeout:
          "Temps de chargement trop long. Merci d'essayer de nouveau dans quelques minutes",
        networkError:
          "Erreur de connexion internet. Merci d'essayer de nouveau dans quelques minutes",
        badStatus: {
          _400:
            "Requête invalide. Merci d'essayer de nouveau dans quelques minutes",
          _401: "Tu dois te connecter à ton compte",
          _403: "Tu n'es pas autorisé(e) à réaliser cette action",
          _404:
            "Requête non trouvée. Merci d'essayer de nouveau dans quelques minutes",
          _422:
            "Données invalides. Merci d'essayer de nouveau dans quelques minutes",
          _461: "La requête est valide mais la ressource n'a pas été trouvée",
          _500:
            "Le serveur est actuellement indisponible. Merci d'essayer de nouveau dans quelques minutes",
          any:
            "Une erreur est apparue, merci de contacter un administrateur avec le code suivant {{code}}"
        },
        badPayload:
          "Le résultat de la requête n'est pas valide. Merci d'essayer de nouveau dans quelques minutes",
      ...
      validation: {
        ...
        mustAcceptTerms:
          "Les conditions générales d'utilisation doivent être lues et acceptées",
        ...
        notCorrectMinLength:
          "Le nombre minmimum de caractères est de {{minLength}}",
        ...
        notBeforeStartTime:
          "Cette date doit être plus tard que la date de début"
      },
      common: {
        close: "Fermer",
        delete: "Supprimer",
